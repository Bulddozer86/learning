(function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
    ...
    },{"./main":27,"./transport-list":29}],15:[function(require,module,exports){
    ...
    },{"./event":17,"inherits":5}],16:[function(require,module,exports){
    ...
    },{"./eventtarget":18,"inherits":5}],17:[function(require,module,exports){
    ...
    },{"./event":17,"inherits":5}],20:[function(require,module,exports){
    ...
    },{"./utils/iframe":60,"json3":6}],21:[function(require,module,exports){
    (function (process){
    ...
    },{"./facade":20,"./info-iframe-receiver":23,"./location":26,"./utils/event":59,"./utils/iframe":60,"./utils/url":65,"_process":11,"debug":3,"json3":6}],22:[function(require,module,exports){
    (function (process){
    ...
    },{"./utils/object":62,"_process":11,"debug":3,"events":16,"inherits":5,"json3":6}],23:[function(require,module,exports){
    ...
    },{"./info-ajax":22,"./transport/sender/xhr-local":50,"events":16,"inherits":5,"json3":6}],24:[function(require,module,exports){
    ...
    },{"./info-iframe-receiver":23,"./transport/iframe":35,"./utils/event":59,"_process":11,"debug":3,"events":16,"inherits":5,"json3":6}],25:[function(require,module,exports){
    (function (process){
    ...
    },{"./info-ajax":22,"./info-iframe":24,"./transport/sender/xdr":47,"./transport/sender/xhr-cors":48,"./transport/sender/xhr-fake":49,"./transport/sender/xhr-local":50,"./utils/url":65,"_process":11,"debug":3,"events":16,"inherits":5}],26:[function(require,module,exports){
    (function (global){
    ...
    },{"./event/close":15,"./event/event":17,"./event/eventtarget":18,"./event/trans-message":19,"./iframe-bootstrap":21,"./info-receiver":25,"./location":26,"./shims":28,"./utils/browser":57,"./utils/escape":58,"./utils/event":59,"./utils/log":61,"./utils/object":62,"./utils/random":63,"./utils/transport":64,"./utils/url":65,"./version":66,"_process":11,"debug":3,"inherits":5,"json3":6,"url-parse":67}],28:[function(require,module,exports){
    ...
    },{"./transport/eventsource":33,"./transport/htmlfile":34,"./transport/jsonp-polling":36,"./transport/lib/iframe-wrap":39,"./transport/websocket":51,"./transport/xdr-polling":52,"./transport/xdr-streaming":53,"./transport/xhr-polling":54,"./transport/xhr-streaming":55}],30:[function(require,module,exports){
    (function (process,global){
    ...
    },{"../../utils/event":59,"../../utils/url":65,"_process":11,"debug":3,"events":16,"inherits":5}],31:[function(require,module,exports){
    (function (global){
    ...
    },{"./lib/ajax-based":37,"./receiver/eventsource":42,"./sender/xhr-cors":48,"eventsource":31,"inherits":5}],34:[function(require,module,exports){
    ...
    },{"./lib/ajax-based":37,"./receiver/htmlfile":43,"./sender/xhr-local":50,"inherits":5}],35:[function(require,module,exports){
    (function (process){
    ...
    },{"../utils/event":59,"../utils/iframe":60,"../utils/random":63,"../utils/url":65,"../version":66,"_process":11,"debug":3,"events":16,"inherits":5,"json3":6}],36:[function(require,module,exports){
    (function (global){
    ...
    },{"./lib/sender-receiver":41,"./receiver/jsonp":44,"./sender/jsonp":46,"inherits":5}],37:[function(require,module,exports){
    (function (process){
    ...
    },{"../../utils/url":65,"./sender-receiver":41,"_process":11,"debug":3,"inherits":5}],38:[function(require,module,exports){
    (function (process){
    ...
    },{"_process":11,"debug":3,"events":16,"inherits":5}],39:[function(require,module,exports){
    (function (global){
    ...
    },{"../../utils/object":62,"../iframe":35,"inherits":5}],40:[function(require,module,exports){
    (function (process){
    ...
    },{"_process":11,"debug":3,"events":16,"inherits":5}],41:[function(require,module,exports){
    (function (process){
    ...
    },{"../../utils/url":65,"./buffered-sender":38,"./polling":40,"_process":11,"debug":3,"inherits":5}],42:[function(require,module,exports){
    (function (process){
    ...
    },{"_process":11,"debug":3,"events":16,"eventsource":31,"inherits":5}],43:[function(require,module,exports){
    (function (process,global){
    ...
    },{"../../utils/iframe":60,"../../utils/random":63,"../../utils/url":65,"_process":11,"debug":3,"events":16,"inherits":5}],44:[function(require,module,exports){
    (function (process,global){
    ...
    },{"../../utils/browser":57,"../../utils/iframe":60,"../../utils/random":63,"../../utils/url":65,"_process":11,"debug":3,"events":16,"inherits":5}],45:[function(require,module,exports){
    (function (process){
    ...
    },{"_process":11,"debug":3,"events":16,"inherits":5}],46:[function(require,module,exports){
    (function (process,global){
    ...
    },{"../../utils/random":63,"../../utils/url":65,"_process":11,"debug":3}],47:[function(require,module,exports){
    (function (process,global){
    ...
    },{"../../utils/browser":57,"../../utils/event":59,"../../utils/url":65,"_process":11,"debug":3,"events":16,"inherits":5}],48:[function(require,module,exports){
    ...
    },{"../driver/xhr":30,"inherits":5}],49:[function(require,module,exports){
    ...
    },{"events":16,"inherits":5}],50:[function(require,module,exports){
    ...
    },{"../driver/xhr":30,"inherits":5}],51:[function(require,module,exports){
    (function (process){
    ...
    },{"../utils/event":59,"../utils/url":65,"./driver/websocket":32,"_process":11,"debug":3,"events":16,"inherits":5}],52:[function(require,module,exports){
    ...
    },{"./lib/ajax-based":37,"./receiver/xhr":45,"./sender/xdr":47,"./xdr-streaming":53,"inherits":5}],53:[function(require,module,exports){
    ...
    },{"./lib/ajax-based":37,"./receiver/xhr":45,"./sender/xdr":47,"inherits":5}],54:[function(require,module,exports){
    ...
    },{"./lib/ajax-based":37,"./receiver/xhr":45,"./sender/xhr-cors":48,"./sender/xhr-local":50,"inherits":5}],55:[function(require,module,exports){
    (function (global){
    ...
    },{"../utils/browser":57,"./lib/ajax-based":37,"./receiver/xhr":45,"./sender/xhr-cors":48,"./sender/xhr-local":50,"inherits":5}],56:[function(require,module,exports){
    (function (global){
    ...
    },{"json3":6}],59:[function(require,module,exports){
    (function (global){
    ...
    },{"./random":63}],60:[function(require,module,exports){
    (function (process,global){
    ...
    },{"./browser":57,"./event":59,"_process":11,"debug":3,"json3":6}],61:[function(require,module,exports){
    (function (global){
    ...
    },{"crypto":56}],64:[function(require,module,exports){
    (function (process){
    ...
    },{"_process":11,"debug":3}],65:[function(require,module,exports){
    (function (process){
    ...
    },{"_process":11,"debug":3,"url-parse":67}],66:[function(require,module,exports){
    ...
    },{"querystringify":12,"requires-port":13}],68:[function(require,module,exports){
    ...
    "use strict";var config=require("./config.js");config.SockJS&&(config.SockJS=require("sockjs-client")),config.WS&&(config.WS=require("ws"));var Events=require("backbone-events-standalone"),Room=require("./room.js"),assign=require("lodash.assign"),get=require("lodash.get"),omit=require("lodash.omit"),sockEvents=require("./sock_events.js"),States={CLOSED:0,OPEN:1,AUTHENTICATED:2},ABNORMAL_CLOSURE=1006,isNode=config.isNode,isBrowser=config.isBrowser,isBrowserLite=config.isBrowserLite,reconnectAttempt=0;function Scaledrone(e,n){var o=this;if(!e)throw new Error("No Channel ID is defined");if(!isString(e))throw new Error("Channel ID must be of type string");n=assign({},{autoReconnect:!0,url:null,originalInstance:this,data:null,debug:!1},n),this.args=arguments,this.args[1]=n,this.originalInstance=n.originalInstance,this.readyState=States.CLOSED,this.callbackId=0,this.callbacks={},this.roomHandlers={},this.disconnected=!1,this.connection=getConnection(n),this.emitter=Events.mixin({}),sockEvents(this.connection,this.emitter,{debug:n.debug}),this.autoReconnect=n.autoReconnect,this.emitter.on("open",function(){o._sendMessage("handshake",{channel:e,version:2,client_data:n.data},function(e,n){e||(o.clientId=n.client_id,o.readyState=States.OPEN),o.trigger("open",e)})}),this.emitter.on("message",function(e){var n=JSON.parse(e.data),t=omit(n,["callback","error"]);if(-1===["observable_members","observable_member_join","observable_member_leave"].indexOf(n.type)){if(null!=n.callback){var r=n.callback,i=o.callbacks[n.callback];return isFunction(i)&&i(wrapError(n.error),t),void delete o.callbacks[r]}n.error?o.trigger("error",wrapError(n.error)):"publish"!==n.type||o.roomHandlers[n.room]({event:"data",data:n.message,clientId:n.client_id})}else o.roomHandlers[n.room]({event:n.type.slice("observable_".length),data:n.data})}),this.emitter.on("close",function(e){o.autoReconnect&&get(e,"code")===ABNORMAL_CLOSURE&&-1===get(e,"reason","").indexOf("exceeded")?(o.disconnected||o.trigger("disconnect"),reconnect(o,n,e)):o.trigger("close",e)}),this.emitter.on("error",function(e){return o.trigger("error",e)}),this.emitter.on("disconnect",function(){return o.disconnected=!0}),this.emitter.on("reconnect",function(){return o.disconnected=!1})}function reconnect(e,n,o){var t=e.originalInstance;if(reconnectAttempt>25)t.trigger("close",o);else{var r=1e3*reconnectAttempt++*(Math.random()+.5);setTimeout(function(){var n=t.args,o=new Scaledrone(n[0],n[1]);o.on("open",function(){for(var n in reconnectAttempt=0,o.emitter=t.emitter,e.connection.old=!0,t.connection=o.connection,sockEvents(o.connection,t.emitter),t.roomHandlers)o.subscribe(n);o.roomHandlers=t.roomHandlers,t.trigger("reconnect")})},r)}}function getConnection(e){return"sockjs"!==e.type&&supportsWebsockets()?isNode?new config.WS(e.url||config.websocketUrl,config.websocketOptions):new WebSocket(e.url||config.websocketUrl):new config.SockJS(e.url||config.sockjsUrl,null,{transports:["xdr","websocket-streaming","xhr-streaming","iframe-eventsource","iframe-htmlfile","xdr-polling","xhr-polling","iframe-xhr-polling","jsonp-polling"]})}function supportsWebsockets(){return!!isBrowserLite||(!(!isNode||"sockjs"===config.type)||!!(isBrowser&&"WebSocket"in window&&2===window.WebSocket.CLOSING))}function wrapError(e){return e?e instanceof Error?e:new Error(e):e}function isFunction(e){return"function"==typeof e}function isString(e){return"string"==typeof e}Events.mixin(Scaledrone.prototype),Scaledrone.prototype._sendMessage=function(e,n,o){var t=assign({type:e},n);if(o){var r=this.callbackId++;t.callback=r,this.callbacks[r]=o}this.connection.send(JSON.stringify(t))},Scaledrone.prototype.subscribe=function(e){if(!e)throw new Error("Room name is not defined");if(!isString(e))throw new Error("Room name must be of type string");var n=new Room(e,this);return this.roomHandlers[e]=function(e){var o=e.event,t=e.data,r=e.clientId,i=void 0;n._observable&&r&&(i=n._getCacheMember(r)),n.trigger(o,t,i)},this._sendMessage("subscribe",{room:e},function(e){n.trigger("open",e)}),n},Scaledrone.prototype.unsubscribe=function(e){if(!e)throw new Error("Room name is not defined");if(!isString(e))throw new Error("Room name must be of type string");this._sendMessage("unsubscribe",{room:e})},Scaledrone.prototype.publish=function(e){if(!e)throw new Error("No options defined");if(!e.room)throw new Error("No room defined");if(!e.message)throw new Error("No message defined");if(this.readyState===States.CLOSED)throw new Error("Connection is closed");this._sendMessage("publish",{room:e.room,message:e.message})},Scaledrone.prototype.authenticate=function(e){var n=this;if(!e)throw new Error("No token defined");this._sendMessage("authenticate",{token:e},function(o){n.readyState=States.AUTHENTICATED,n.token=e,n.trigger("authenticate",o)})},Scaledrone.prototype.close=function(){this.connection.close()},isBrowser?window.ScaleDrone=window.Scaledrone=Scaledrone:module.exports=Scaledrone;
    
    },{"./config.js":68,"./room.js":70,"./sock_events.js":71,"backbone-events-standalone":2,"lodash.assign":7,"lodash.get":8,"lodash.omit":9,"sockjs-client":14,"ws":undefined}],70:[function(require,module,exports){
    "use strict";var Events=require("backbone-events-standalone");function Room(e,t){var n=this;this.name=e,this.channel=t,this._observable=isObservable(e),this._observable&&(this._cache=[],this.on("members",function(e){return n._cache=e.slice(0)}),this.on("member_join",function(e){return n._cache.unshift(e)}))}function isObservable(e){return e&&"observable-"===e.substring(0,11)}Events.mixin(Room.prototype),Room.prototype.unsubscribe=function(){this.off(),this.channel.unsubscribe(this.name)},Room.prototype._getCacheMember=function(e){if("string"!=typeof e)return null;for(var t=0;t<this._cache.length;t++){var n=this._cache[t];if(n.id===e)return n}return null},module.exports=Room;
    
    },{"backbone-events-standalone":2}],71:[function(require,module,exports){
